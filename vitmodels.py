...
class lstm_encoder(nn.Module):
    def __init__(self, indim, hiddendim, fcdim, outdim, n_layers, dropout=0.1):
        super(lstm_encoder, self).__init__()
        self.lstm = torch.nn.LSTM(input_size=indim, hidden_size=hiddendim, batch_first=True, bidirectional=False, num_layers=n_layers)
        self.dropout = torch.nn.Dropout(dropout)
        self.fc1 = torch.nn.Linear(hiddendim, fcdim)
